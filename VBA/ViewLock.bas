...
' v2025-02-17
'
'   2025-02-17 - Added Outlook. qualifier to olXxx enumeration constants.
'   2025-02-15 - Additional RubberDuck cleanup.
'
' =====================================================================
...
ViewLock_Folders = False
    ...
    For Each oSubFolder In oFolder.Folders
        If Not ViewLock_Folders(oSubFolder) Then Exit Function
    Next oSubFolder
...
Private Function ViewLock_ViewVType(ByVal oView As Outlook.View) As Long
    ...
    Select Case oView.SaveOption
        Case Outlook.olViewSaveOptionAllFoldersOfType
            ViewLock_ViewVType = VTypes_Shared
        Case Outlook.olViewSaveOptionThisFolderEveryone
            ViewLock_ViewVType = VTypes_Public
        Case Outlook.olViewSaveOptionThisFolderOnlyMe
