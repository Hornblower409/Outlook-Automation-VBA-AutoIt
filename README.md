...
* Track events from multiple Outlook Explorers and Inspectors VBA classes.
...
* Replacing Custom Form VBScript with VBA.
* Flag for Follow Up custom form and support functions.
* Wrapper for common Word Editor operations.
* Generating and managing Hyperlinks between Outlook items.
